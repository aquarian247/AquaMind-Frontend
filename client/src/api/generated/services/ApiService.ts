...
import type { AllocationRule } from '../models/AllocationRule';
import type { Area } from '../models/Area';
import type { AreaGroup } from '../models/AreaGroup';
import type { AreaGroupHistory } from '../models/AreaGroupHistory';
...
import type { BudgetAllocate } from '../models/BudgetAllocate';
import type { BudgetCopy } from '../models/BudgetCopy';
import type { BudgetEntry } from '../models/BudgetEntry';
import type { BudgetEntryBulkImport } from '../models/BudgetEntryBulkImport';
import type { CompanyDimension } from '../models/CompanyDimension';
import type { Container } from '../models/Container';
import type { ContainerAvailabilityResponse } from '../models/ContainerAvailabilityResponse';
...
import type { CostImportBatch } from '../models/CostImportBatch';
import type { CostImportUpload } from '../models/CostImportUpload';
...
import type { MovementReportQuery } from '../models/MovementReportQuery';
import type { NavExportBatch } from '../models/NavExportBatch';
import type { NavExportBatchCreate } from '../models/NavExportBatchCreate';
import type { NavExportPreviewQuery } from '../models/NavExportPreviewQuery';
import type { PaginatedAccountGroupList } from '../models/PaginatedAccountGroupList';
...
import type { PaginatedAllocationRuleList } from '../models/PaginatedAllocationRuleList';
import type { PaginatedAreaGroupHistoryList } from '../models/PaginatedAreaGroupHistoryList';
import type { PaginatedAreaGroupList } from '../models/PaginatedAreaGroupList';
...
import type { PaginatedBudgetEntryList } from '../models/PaginatedBudgetEntryList';
import type { PaginatedBudgetList } from '../models/PaginatedBudgetList';
import type { PaginatedCompanyDimensionList } from '../models/PaginatedCompanyDimensionList';
...
import type { PaginatedCostCenterList } from '../models/PaginatedCostCenterList';
import type { PaginatedCostImportBatchList } from '../models/PaginatedCostImportBatchList';
...
import type { PaginatedPeriodLockList } from '../models/PaginatedPeriodLockList';
...
import type { PaginatedSiteDimensionList } from '../models/PaginatedSiteDimensionList';
...
import type { PaginatedTransportCarrierHistoryList } from '../models/PaginatedTransportCarrierHistoryList';
import type { PaginatedTransportCarrierList } from '../models/PaginatedTransportCarrierList';
...
import type { PaginatedValuationRunList } from '../models/PaginatedValuationRunList';
...
import type { PatchedAccountGroup } from '../models/PatchedAccountGroup';
import type { PatchedActivityTemplate } from '../models/PatchedActivityTemplate';
import type { PatchedAllocationRule } from '../models/PatchedAllocationRule';
import type { PatchedArea } from '../models/PatchedArea';
import type { PatchedAreaGroup } from '../models/PatchedAreaGroup';
...
import type { PatchedBatchCreationWorkflowDetail } from '../models/PatchedBatchCreationWorkflowDetail';
...
import type { PatchedBudgetEntry } from '../models/PatchedBudgetEntry';
...
import type { PatchedCostCenter } from '../models/PatchedCostCenter';
import type { PatchedCreationAction } from '../models/PatchedCreationAction';
...
import type { PatchedTransportCarrier } from '../models/PatchedTransportCarrier';
...
import type { PeriodLock } from '../models/PeriodLock';
import type { PeriodLockAction } from '../models/PeriodLockAction';
import type { PeriodUnlock } from '../models/PeriodUnlock';
...
import type { SiteDimension } from '../models/SiteDimension';
...
import type { TransferActionSnapshot } from '../models/TransferActionSnapshot';
import type { TransferHandoffComplete } from '../models/TransferHandoffComplete';
import type { TransferHandoffStart } from '../models/TransferHandoffStart';
import type { TransportCarrier } from '../models/TransportCarrier';
import type { TransportCarrierHistory } from '../models/TransportCarrierHistory';
...
import type { ValuationRun } from '../models/ValuationRun';
import type { ValuationRunRequest } from '../models/ValuationRunRequest';
...
export class ApiService {
     ...
     * @param status * `PLANNED` - Planned - Awaiting Delivery
     * * `RECEIVING` - Receiving - Partial Delivery
     * * `ACTIVE` - Active
     * * `COMPLETED` - Completed
     * * `TERMINATED` - Terminated
     * * `CANCELLED` - Cancelled - Never Delivered
     * @param statusIn * `PLANNED` - Planned - Awaiting Delivery
     * * `RECEIVING` - Receiving - Partial Delivery
     * * `ACTIVE` - Active
     * * `COMPLETED` - Completed
     * * `TERMINATED` - Terminated
    ...
    public static apiV1BatchBatchesList(
        ...
        status?: 'ACTIVE' | 'CANCELLED' | 'COMPLETED' | 'PLANNED' | 'RECEIVING' | 'TERMINATED',
        statusIn?: Array<'ACTIVE' | 'CANCELLED' | 'COMPLETED' | 'PLANNED' | 'RECEIVING' | 'TERMINATED'>,
     ...
     * @throws ApiError
     */
    public static apiV1BatchBatchesMixedLineageRetrieve(
        id: number,
    ): CancelablePromise<Batch> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/batch/batches/{id}/mixed-lineage/',
            path: {
                'id': id,
            },
            errors: {
    ...
    public static batchPinScenario(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/batch/batches/{id}/pin-projection-run/',
            path: {
                'id': id,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static apiV1BatchBatchesPinScenarioCreate(
        id: number,
        requestBody: Batch,
    ): CancelablePromise<Batch> {
        return __request(OpenAPI, {
    ...
    /**
     * Get live forward projection for an assignment
     *
     ...
     *
     * @param id A unique integer value identifying this batch container assignment.
     * @param computedDate Date of projection run (YYYY-MM-DD). Default: latest.
     * @returns any Live forward projection series with provenance
     * @throws ApiError
     */
    public static batchContainerAssignmentsLiveForwardProjection(
        id: number,
        computedDate?: string,
    ): CancelablePromise<{
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/batch/container-assignments/{id}/live-forward-projection/',
            path: {
                'id': id,
            },
            query: {
     ...
     * @returns ContainerAvailabilityResponse
     * @throws ApiError
     */
    public static apiV1BatchContainersAvailabilityRetrieve(
        id: number,
    ): CancelablePromise<ContainerAvailabilityResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/batch/containers/availability/{id}/',
            path: {
                'id': id,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static apiV1BatchCreationActionsPartialUpdate(
        id: number,
        requestBody?: PatchedCreationAction,
     ...
     * @throws ApiError
     */
    public static apiV1BatchCreationActionsDestroy(
        id: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    public static apiV1BatchCreationWorkflowsUpdate(
        id: number,
        requestBody: BatchCreationWorkflowDetail,
     ...
     * @throws ApiError
     */
    public static apiV1BatchCreationWorkflowsPartialUpdate(
        id: number,
        requestBody?: PatchedBatchCreationWorkflowDetail,
    ): CancelablePromise<BatchCreationWorkflowDetail> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/batch/creation-workflows/{id}/',
     ...
     * @throws ApiError
     */
    public static apiV1BatchCreationWorkflowsDestroy(
        id: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     *
     * Uses projection data to find the earliest date when batches will reach species-specific harvest weight thresholds, enriched with confidence scores from actual daily states and existing planned HARVEST activities.
     *
     * Useful for executive dashboards and harvest planning.
     * @param fromDate Filter projections from this date (ISO 8601: YYYY-MM-DD)
     * @param geographyId Filter by geography ID (optional)
     * @param minConfidence Minimum confidence score (0-1, default 0.5)
     * @param speciesId Filter by species ID (optional)
     * @param toDate Filter projections until this date (ISO 8601: YYYY-MM-DD)
     * @returns any Harvest forecast data
     * @throws ApiError
     */
    public static forecastviewsetHarvest(
        fromDate?: string,
        geographyId?: number,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/batch/forecast/harvest/',
            query: {
                'from_date': fromDate,
     ...
     * Returns aggregated sea-transfer forecast showing freshwater batches approaching smolt weight threshold for transfer to sea cages.
     *
     * Only includes batches currently in freshwater facilities (containers in halls). Uses projection data to find the earliest date when batches will reach species-specific transfer weight thresholds.
     *
     ...
     * @param speciesId Filter by species ID (optional)
     * @param toDate Filter projections until this date (ISO 8601: YYYY-MM-DD)
     * @returns any Sea-transfer forecast data
     * @throws ApiError
     */
    public static forecastviewsetSeaTransfer(
        fromDate?: string,
        geographyId?: number,
        minConfidence?: number,
        speciesId?: number,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/batch/forecast/sea-transfer/',
            query: {
                'from_date': fromDate,
                'geography_id': geographyId,
                'min_confidence': minConfidence,
    ...
    /**
     * Get tiered harvest forecast (PLANNED/PROJECTED/NEEDS_PLANNING)
     *
     ...
     * @param geographyId Filter by geography ID
     * @param tier Filter by tier (PLANNED, PROJECTED, NEEDS_PLANNING)
     * @returns any Tiered harvest forecast
     * @throws ApiError
     */
    public static forecastviewsetTieredHarvest(
        daysHorizon?: number,
        geographyId?: number,
        tier?: string,
    ): CancelablePromise<{
     ...
     * Completes an IN_PROGRESS dynamic handoff by applying actual counts/biomass/mortality and marking action COMPLETED.
     * @param id A unique integer value identifying this Transfer Action.
     * @param requestBody
     * @returns any
     * @throws ApiError
     */
    public static apiV1BatchTransferActionsCompleteHandoffCreate(
        id: number,
        requestBody: TransferHandoffComplete,
    ): CancelablePromise<Record<string, any>> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/batch/transfer-actions/{id}/complete-handoff/',
            path: {
                'id': id,
            },
            body: requestBody,
    ...
    /**
     * Capture transport snapshot readings
     * Capture mapped AVEVA historian readings for this transfer action at a specific moment (start, in_transit, finish).
     * @param id A unique integer value identifying this Transfer Action.
     * @param requestBody
     * @returns any
     * @throws ApiError
     */
    public static apiV1BatchTransferActionsSnapshotCreate(
        id: number,
        requestBody: TransferActionSnapshot,
    ): CancelablePromise<{
        action_id?: number;
        moment?: string;
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/batch/transfer-actions/{id}/snapshot/',
            path: {
                'id': id,
            },
            body: requestBody,
     ...
     * @param dynamicRouteMode Dynamic route pattern for station-to-sea workflows. Required when is_dynamic_execution is true.
     *
     * * `DIRECT_STATION_TO_VESSEL` - Direct Station to Vessel
     * * `VIA_TRUCK_TO_VESSEL` - Via Truck to Vessel
     * @param initiatedBy
     * @param isDynamicExecution
    ...
    public static apiV1BatchTransferWorkflowsList(
        ...
        dynamicRouteMode?: 'DIRECT_STATION_TO_VESSEL' | 'VIA_TRUCK_TO_VESSEL' | null,
        initiatedBy?: number,
        ...
        workflowType?: 'CONTAINER_REDISTRIBUTION' | 'EMERGENCY_CASCADE' | 'LIFECYCLE_TRANSITION',
        workflowTypeIn?: Array<'CONTAINER_REDISTRIBUTION' | 'EMERGENCY_CASCADE' | 'LIFECYCLE_TRANSITION'>,
        ...
        return __request(OpenAPI, {
            ...
            query: {
                ...
                'dynamic_route_mode': dynamicRouteMode,
     ...
     * Explicit completion endpoint for dynamic transfer workflows. Blocks completion while handoffs remain IN_PROGRESS and requires at least one completed handoff.
     * @param id A unique integer value identifying this Batch Transfer Workflow.
     * @param requestBody
     * @returns BatchTransferWorkflowDetail
     * @throws ApiError
     */
    public static apiV1BatchTransferWorkflowsCompleteDynamicCreate(
        id: number,
        requestBody?: {
            completion_note?: string;
        },
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/batch/transfer-workflows/{id}/complete-dynamic/',
            path: {
                'id': id,
            },
            body: requestBody,
     ...
     * Returns live sources, destination candidates, allowed legs, in-progress handoffs and progress details for the execution page.
     * @param id A unique integer value identifying this Batch Transfer Workflow.
     * @returns any
     * @throws ApiError
     */
    public static apiV1BatchTransferWorkflowsExecutionContextRetrieve(
        id: number,
    ): CancelablePromise<Record<string, any>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/batch/transfer-workflows/{id}/execution-context/',
            path: {
                'id': id,
            },
            errors: {
    ...
    /**
     * Dynamic handoff start
     * Start a dynamic handoff in a dedicated two-step flow. Creates an IN_PROGRESS TransferAction and captures mandatory start compliance snapshots.
     * @param id A unique integer value identifying this Batch Transfer Workflow.
     * @param requestBody
     * @returns any
     * @throws ApiError
     */
    public static apiV1BatchTransferWorkflowsHandoffsStartCreate(
        id: number,
        requestBody: TransferHandoffStart,
    ): CancelablePromise<{
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/batch/transfer-workflows/{id}/handoffs/start/',
            path: {
                'id': id,
            },
            body: requestBody,
     ...
     * @param parent
     * @param search A search term.
     * @returns PaginatedAccountGroupList
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountGroupsList(
        ...
        parent?: number,
        search?: string,
    ): CancelablePromise<PaginatedAccountGroupList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/account-groups/',
            query: {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountGroupsCreate(
    ...
    /**
     * @param groupId A unique integer value identifying this account group.
     * @returns AccountGroup
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountGroupsRetrieve(
        groupId: number,
    ): CancelablePromise<AccountGroup> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/account-groups/{group_id}/',
            path: {
                'group_id': groupId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountGroupsUpdate(
        groupId: number,
        requestBody: AccountGroup,
    ): CancelablePromise<AccountGroup> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountGroupsPartialUpdate(
        groupId: number,
        requestBody?: PatchedAccountGroup,
    ): CancelablePromise<AccountGroup> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/finance-core/account-groups/{group_id}/',
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountGroupsDestroy(
        groupId: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountsList(
        accountType?: 'ASSET' | 'EQUITY' | 'EXPENSE' | 'LIABILITY' | 'REVENUE',
        group?: number,
        isActive?: boolean,
        ordering?: string,
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/accounts/',
            query: {
                'account_type': accountType,
                'group': group,
                'is_active': isActive,
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountsCreate(
        requestBody: Account,
    ...
    /**
     * @param accountId A unique integer value identifying this account.
     * @returns Account
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountsRetrieve(
        accountId: number,
    ): CancelablePromise<Account> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/accounts/{account_id}/',
            path: {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountsUpdate(
        accountId: number,
        requestBody: Account,
    ): CancelablePromise<Account> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountsPartialUpdate(
        accountId: number,
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAccountsDestroy(
        accountId: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @param page A page number within the paginated result set.
     * @param search A search term.
     * @returns PaginatedAllocationRuleList
     * @throws ApiError
     */
    public static apiV1FinanceCoreAllocationRulesList(
        accountGroup?: number,
        costCenter?: number,
        isActive?: boolean,
        ordering?: string,
        page?: number,
        search?: string,
    ): CancelablePromise<PaginatedAllocationRuleList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/allocation-rules/',
            query: {
    ...
    /**
     * @param requestBody
     * @returns AllocationRule
     * @throws ApiError
     */
    public static apiV1FinanceCoreAllocationRulesCreate(
        requestBody: AllocationRule,
    ): CancelablePromise<AllocationRule> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/allocation-rules/',
            body: requestBody,
    ...
    /**
     * @param ruleId A unique integer value identifying this allocation rule.
     * @returns AllocationRule
     * @throws ApiError
     */
    public static apiV1FinanceCoreAllocationRulesRetrieve(
        ruleId: number,
    ): CancelablePromise<AllocationRule> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/allocation-rules/{rule_id}/',
            path: {
                'rule_id': ruleId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAllocationRulesUpdate(
        ruleId: number,
        requestBody: AllocationRule,
    ): CancelablePromise<AllocationRule> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAllocationRulesPartialUpdate(
        ruleId: number,
        requestBody?: PatchedAllocationRule,
    ): CancelablePromise<AllocationRule> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/finance-core/allocation-rules/{rule_id}/',
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreAllocationRulesDestroy(
        ruleId: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @param page A page number within the paginated result set.
     * @param search A search term.
     * @returns PaginatedBudgetEntryList
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetEntriesList(
        account?: number,
        budget?: number,
        costCenter?: number,
        maxAmount?: number,
        ...
        page?: number,
        search?: string,
    ): CancelablePromise<PaginatedBudgetEntryList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/budget-entries/',
            query: {
                'account': account,
                'budget': budget,
                'cost_center': costCenter,
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetEntriesCreate(
        requestBody: BudgetEntry,
    ): CancelablePromise<BudgetEntry> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/budget-entries/',
            body: requestBody,
    ...
    /**
     * @param entryId A unique integer value identifying this budget entry.
     * @returns BudgetEntry
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetEntriesRetrieve(
        entryId: number,
    ): CancelablePromise<BudgetEntry> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/budget-entries/{entry_id}/',
            path: {
                'entry_id': entryId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetEntriesUpdate(
        entryId: number,
        requestBody: BudgetEntry,
    ): CancelablePromise<BudgetEntry> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetEntriesPartialUpdate(
        entryId: number,
        requestBody?: PatchedBudgetEntry,
    ): CancelablePromise<BudgetEntry> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/finance-core/budget-entries/{entry_id}/',
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetEntriesDestroy(
        entryId: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetEntriesBulkImportCreate(
        requestBody: BudgetEntryBulkImport,
        account?: number,
        budget?: number,
        costCenter?: number,
        maxAmount?: number,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/budget-entries/bulk-import/',
            query: {
                'account': account,
                'budget': budget,
                'cost_center': costCenter,
     ...
     * * `ACTIVE` - Active
     * * `ARCHIVED` - Archived
     * @returns PaginatedBudgetList
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsList(
        company?: number,
        fiscalYear?: number,
        ordering?: string,
        page?: number,
    ...
    ): CancelablePromise<PaginatedBudgetList> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsCreate(
        requestBody: Budget,
    ...
    /**
     * @param budgetId A unique integer value identifying this budget.
     * @returns Budget
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsRetrieve(
        budgetId: number,
    ): CancelablePromise<Budget> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/budgets/{budget_id}/',
            path: {
                'budget_id': budgetId,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsUpdate(
        budgetId: number,
        requestBody: Budget,
    ): CancelablePromise<Budget> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsPartialUpdate(
        budgetId: number,
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsDestroy(
        budgetId: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @param budgetId A unique integer value identifying this budget.
     * @param requestBody
     * @returns ValuationRun
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsAllocateCreate(
        budgetId: number,
        requestBody: BudgetAllocate,
    ): CancelablePromise<ValuationRun> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/budgets/{budget_id}/allocate/',
            path: {
                'budget_id': budgetId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsCopyCreate(
        budgetId: number,
        requestBody: BudgetCopy,
    ): CancelablePromise<Budget> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/budgets/{budget_id}/copy/',
            path: {
                'budget_id': budgetId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreBudgetsValuationRunCreate(
        budgetId: number,
        requestBody: ValuationRunRequest,
    ): CancelablePromise<ValuationRun> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/budgets/{budget_id}/valuation-run/',
            path: {
                'budget_id': budgetId,
            },
            body: requestBody,
     ...
     * @param page A page number within the paginated result set.
     * @param search A search term.
     * @param subsidiary * `BS` - Broodstock
     * * `FW` - Freshwater
     * * `FM` - Farming
     * * `LG` - Logistics
     * * `ALL` - All Subsidiaries
     * @returns PaginatedCompanyDimensionList
     * @throws ApiError
     */
    public static apiV1FinanceCoreCompaniesList(
        geography?: number,
        ordering?: string,
        page?: number,
        search?: string,
        subsidiary?: 'ALL' | 'BS' | 'FM' | 'FW' | 'LG',
    ): CancelablePromise<PaginatedCompanyDimensionList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/companies/',
            query: {
                'geography': geography,
                'ordering': ordering,
                'page': page,
    ...
    /**
     * @param companyId A unique integer value identifying this Finance Company.
     * @returns CompanyDimension
     * @throws ApiError
     */
    public static apiV1FinanceCoreCompaniesRetrieve(
        companyId: number,
    ): CancelablePromise<CompanyDimension> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/companies/{company_id}/',
            path: {
    ...
    /**
     * @param company
     * @param costCenterType * `SITE` - Site
     * * `PROJECT` - Project
     ...
     * @param search A search term.
     * @param site
     * @returns PaginatedCostCenterList
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostCentersList(
        company?: number,
        costCenterType?: 'DEPARTMENT' | 'OTHER' | 'PROJECT' | 'SITE',
        isActive?: boolean,
        ordering?: string,
        page?: number,
        parent?: number,
        search?: string,
        site?: number,
    ): CancelablePromise<PaginatedCostCenterList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/cost-centers/',
            query: {
                'company': company,
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostCentersCreate(
        requestBody: CostCenter,
    ): CancelablePromise<CostCenter> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/cost-centers/',
            body: requestBody,
    ...
    /**
     * @param costCenterId A unique integer value identifying this cost center.
     * @returns CostCenter
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostCentersRetrieve(
        costCenterId: number,
    ): CancelablePromise<CostCenter> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/cost-centers/{cost_center_id}/',
            path: {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostCentersUpdate(
        costCenterId: number,
        requestBody: CostCenter,
    ): CancelablePromise<CostCenter> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostCentersPartialUpdate(
        costCenterId: number,
        requestBody?: PatchedCostCenter,
    ): CancelablePromise<CostCenter> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/finance-core/cost-centers/{cost_center_id}/',
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostCentersDestroy(
        costCenterId: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @param page A page number within the paginated result set.
     * @param year
     * @returns PaginatedCostImportBatchList
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostImportsList(
        month?: number,
        ordering?: string,
        page?: number,
        year?: number,
    ): CancelablePromise<PaginatedCostImportBatchList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/cost-imports/',
            query: {
                'month': month,
                'ordering': ordering,
                'page': page,
    ...
    /**
     * @param requestBody
     * @returns CostImportBatch
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostImportsCreate(
        requestBody: CostImportUpload,
    ): CancelablePromise<CostImportBatch> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/cost-imports/',
            body: requestBody,
    ...
    /**
     * @param importBatchId A unique integer value identifying this cost import batch.
     * @returns CostImportBatch
     * @throws ApiError
     */
    public static apiV1FinanceCoreCostImportsRetrieve(
        importBatchId: number,
    ): CancelablePromise<CostImportBatch> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/cost-imports/{import_batch_id}/',
            path: {
     ...
     * @param page A page number within the paginated result set.
     * @param search A search term.
     * @param sourceModel * `station` - Freshwater Station
     * * `area` - Area
     * @returns PaginatedSiteDimensionList
     * @throws ApiError
     */
    public static apiV1FinanceCoreOperatingUnitsList(
        company?: number,
        ordering?: string,
        page?: number,
        search?: string,
        sourceModel?: 'area' | 'station',
    ): CancelablePromise<PaginatedSiteDimensionList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/operating-units/',
            query: {
                'company': company,
                'ordering': ordering,
                'page': page,
    ...
    /**
     * @param siteId A unique integer value identifying this Finance Site.
     * @returns SiteDimension
     * @throws ApiError
     */
    public static apiV1FinanceCoreOperatingUnitsRetrieve(
        siteId: number,
    ): CancelablePromise<SiteDimension> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/operating-units/{site_id}/',
            path: {
                'site_id': siteId,
            },
            errors: {
     ...
     * @param page A page number within the paginated result set.
     * @param year
     * @returns PaginatedPeriodLockList
     * @throws ApiError
     */
    public static apiV1FinanceCorePeriodsList(
        company?: number,
        isLocked?: boolean,
        month?: number,
        ...
        page?: number,
        year?: number,
    ): CancelablePromise<PaginatedPeriodLockList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/periods/',
            query: {
                'company': company,
                'is_locked': isLocked,
                'month': month,
    ...
    /**
     * @param periodLockId A unique integer value identifying this period lock.
     * @returns PeriodLock
     * @throws ApiError
     */
    public static apiV1FinanceCorePeriodsRetrieve(
        periodLockId: number,
    ): CancelablePromise<PeriodLock> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/periods/{period_lock_id}/',
            path: {
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCorePeriodsUnlockCreate(
        periodLockId: number,
        requestBody: PeriodUnlock,
    ): CancelablePromise<PeriodLock> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/periods/{period_lock_id}/unlock/',
            path: {
                'period_lock_id': periodLockId,
            },
            body: requestBody,
     ...
     * @throws ApiError
     */
    public static apiV1FinanceCorePeriodsLockCreate(
        requestBody: PeriodLockAction,
    ): CancelablePromise<PeriodLock> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/finance-core/periods/lock/',
            body: requestBody,
            mediaType: 'application/json',
            errors: {
                400: `Bad request (validation error)`,
    ...
    /**
     * @returns MovementReportQuery
     * @throws ApiError
     */
    public static apiV1FinanceCoreReportsMovementRetrieve(): CancelablePromise<MovementReportQuery> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/reports/movement/',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                500: `Internal Server Error`,
    ...
    /**
     * @returns NavExportPreviewQuery
     * @throws ApiError
     */
    public static apiV1FinanceCoreReportsNavExportPreviewRetrieve(): CancelablePromise<NavExportPreviewQuery> {
        return __request(OpenAPI, {
            method: 'GET',
    ...
    /**
     * @returns RingValuationQuery
     * @throws ApiError
     */
    public static apiV1FinanceCoreReportsRingValuationRetrieve(): CancelablePromise<RingValuationQuery> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/reports/ring-valuation/',
            errors: {
                401: `Unauthorized`,
                403: `Forbidden`,
                500: `Internal Server Error`,
     ...
     * @param ordering Which field to use when ordering the results.
     * @param page A page number within the paginated result set.
     * @param status * `PREVIEW` - Preview
     * * `APPROVED` - Approved
     * * `EXPORTED` - Exported
     * * `FAILED` - Failed
     * @param year
     * @returns PaginatedValuationRunList
     * @throws ApiError
     */
    public static apiV1FinanceCoreValuationRunsList(
        budget?: number,
        company?: number,
        month?: number,
        operatingUnit?: number,
        ordering?: string,
        page?: number,
        status?: 'APPROVED' | 'EXPORTED' | 'FAILED' | 'PREVIEW',
        year?: number,
    ): CancelablePromise<PaginatedValuationRunList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/valuation-runs/',
            query: {
                'budget': budget,
                'company': company,
                'month': month,
    ...
    /**
     * @param runId A unique integer value identifying this valuation run.
     * @returns ValuationRun
     * @throws ApiError
     */
    public static apiV1FinanceCoreValuationRunsRetrieve(
        runId: number,
    ): CancelablePromise<ValuationRun> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/finance-core/valuation-runs/{run_id}/',
            path: {
                'run_id': runId,
            },
            errors: {
     ...
     * @param page A page number within the paginated result set.
     * @param parent
     * @param parentIn Multiple values may be separated by commas.
     * @param parentIsnull
     * @param search A search term.
     * @returns PaginatedAreaGroupList
     * @throws ApiError
     */
    public static apiV1InfrastructureAreaGroupsList(
        active?: boolean,
        code?: string,
        ...
        search?: string,
    ): CancelablePromise<PaginatedAreaGroupList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infrastructure/area-groups/',
            query: {
                'active': active,
                'code': code,
                'code__icontains': codeIcontains,
                'geography': geography,
     ...
     * @throws ApiError
     */
    public static apiV1InfrastructureAreaGroupsCreate(
        requestBody: AreaGroup,
    ): CancelablePromise<AreaGroup> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/infrastructure/area-groups/',
            body: requestBody,
     ...
     * Area groups provide optional hierarchical grouping for sea areas:
     * Geography -> AreaGroup -> Area -> Containers.
     * @param id A unique integer value identifying this area group.
     * @returns AreaGroup
     * @throws ApiError
     */
    public static apiV1InfrastructureAreaGroupsRetrieve(
        id: number,
    ): CancelablePromise<AreaGroup> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infrastructure/area-groups/{id}/',
            path: {
                'id': id,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static apiV1InfrastructureAreaGroupsUpdate(
        id: number,
        requestBody: AreaGroup,
    ): CancelablePromise<AreaGroup> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static apiV1InfrastructureAreaGroupsPartialUpdate(
        id: number,
        requestBody?: PatchedAreaGroup,
    ): CancelablePromise<AreaGroup> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/infrastructure/area-groups/{id}/',
     ...
     * @throws ApiError
     */
    public static apiV1InfrastructureAreaGroupsDestroy(
        id: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @param active
     * @param areaGroup
     * @param areaGroupIn Multiple values may be separated by commas.
     * @param geography
     * @param geographyIn Multiple values may be separated by commas.
     * @param name
     * @param nameIcontains
    ...
    public static areaSummary(
        ...
        /**
         * Active batches with assignments in this area
         */
     ...
     * @param areaIn Multiple values may be separated by commas.
     * @param carrier
     * @param carrierCarrierType * `TRUCK` - Truck
     * * `VESSEL` - Vessel
     * @param carrierIn Multiple values may be separated by commas.
     * @param containerType
     * @param containerTypeCategory * `TANK` - Tank
     * * `PEN` - Pen
     * * `TRAY` - Tray
     * * `OTHER` - Other
     * @param hall
     * @param hallIn Multiple values may be separated by commas.
     * @param hierarchyRole * `HOLDING` - Holding
     * * `STRUCTURAL` - Structural
     * @param name
     * @param ordering Which field to use when ordering the results.
     * @param page A page number within the paginated result set.
     * @param parentContainer
     * @param parentContainerIn Multiple values may be separated by commas.
     * @param parentContainerIsnull
     * @param search A search term.
    ...
    public static apiV1InfrastructureContainersList(
        ...
        areaIn?: Array<number>,
        carrier?: number,
        carrierCarrierType?: 'TRUCK' | 'VESSEL',
        carrierIn?: Array<number>,
        containerType?: number,
        containerTypeCategory?: 'OTHER' | 'PEN' | 'TANK' | 'TRAY',
        hall?: number,
        hallIn?: Array<number>,
        ...
        parentContainerIn?: Array<number>,
        ...
        return __request(OpenAPI, {
            ...
            query: {
                ...
                'area__in': areaIn,
                'carrier': carrier,
                'carrier__carrier_type': carrierCarrierType,
                'carrier__in': carrierIn,
                'container_type': containerType,
                'container_type__category': containerTypeCategory,
                'hall': hall,
                'hall__in': hallIn,
                ...
                'parent_container__in': parentContainerIn,
                'parent_container__isnull': parentContainerIsnull,
                'search': search,
            },
            errors: {
                400: `Bad request (validation error)`,
     ...
     * @param parent
     * @param search A search term.
     * @returns PaginatedAreaGroupHistoryList
     * @throws ApiError
     */
    public static apiV1InfrastructureHistoryAreaGroupsList(
        active?: boolean,
        code?: string,
        dateFrom?: string,
        dateTo?: string,
        ...
        parent?: number,
        search?: string,
    ): CancelablePromise<PaginatedAreaGroupHistoryList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infrastructure/history/area-groups/',
            query: {
                'active': active,
                'code': code,
                'date_from': dateFrom,
     ...
     * @param historyId A unique integer value identifying this historical area group.
     * @returns AreaGroupHistory
     * @throws ApiError
     */
    public static apiV1InfrastructureHistoryAreaGroupsRetrieve(
        historyId: number,
    ): CancelablePromise<AreaGroupHistory> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infrastructure/history/area-groups/{history_id}/',
            path: {
                'history_id': historyId,
            },
            errors: {
     ...
     * @param page A page number within the paginated result set.
     * @param search A search term.
     * @returns PaginatedTransportCarrierHistoryList
     * @throws ApiError
     */
    public static apiV1InfrastructureHistoryTransportCarriersList(
        active?: boolean,
        carrierType?: 'TRUCK' | 'VESSEL',
        dateFrom?: string,
        dateTo?: string,
        geography?: number,
        historyType?: '+' | '-' | '~',
        ...
        page?: number,
        search?: string,
    ): CancelablePromise<PaginatedTransportCarrierHistoryList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infrastructure/history/transport-carriers/',
            query: {
                'active': active,
     ...
     * @param historyId A unique integer value identifying this historical transport carrier.
     * @returns TransportCarrierHistory
     * @throws ApiError
     */
    public static apiV1InfrastructureHistoryTransportCarriersRetrieve(
        historyId: number,
    ): CancelablePromise<TransportCarrierHistory> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infrastructure/history/transport-carriers/{history_id}/',
            path: {
                'history_id': historyId,
            },
            errors: {
     ...
     * @param page A page number within the paginated result set.
     * @param search A search term.
     * @returns PaginatedTransportCarrierList
     * @throws ApiError
     */
    public static apiV1InfrastructureTransportCarriersList(
        active?: boolean,
        carrierType?: 'TRUCK' | 'VESSEL',
        geography?: number,
        ordering?: string,
        page?: number,
        search?: string,
    ): CancelablePromise<PaginatedTransportCarrierList> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infrastructure/transport-carriers/',
            query: {
                'active': active,
                'carrier_type': carrierType,
                'geography': geography,
     ...
     * CRUD endpoint for logistics transport carriers (trucks/vessels).
     * @param requestBody
     * @returns TransportCarrier
     * @throws ApiError
     */
    public static apiV1InfrastructureTransportCarriersCreate(
        requestBody: TransportCarrier,
    ): CancelablePromise<TransportCarrier> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/infrastructure/transport-carriers/',
            body: requestBody,
    ...
    /**
     * CRUD endpoint for logistics transport carriers (trucks/vessels).
     * @param id A unique integer value identifying this transport carrier.
     * @returns TransportCarrier
     * @throws ApiError
     */
    public static apiV1InfrastructureTransportCarriersRetrieve(
        id: number,
    ): CancelablePromise<TransportCarrier> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/infrastructure/transport-carriers/{id}/',
            path: {
                'id': id,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static apiV1InfrastructureTransportCarriersUpdate(
        id: number,
        requestBody: TransportCarrier,
    ): CancelablePromise<TransportCarrier> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static apiV1InfrastructureTransportCarriersPartialUpdate(
        id: number,
        requestBody?: PatchedTransportCarrier,
    ): CancelablePromise<TransportCarrier> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/infrastructure/transport-carriers/{id}/',
     ...
     * @throws ApiError
     */
    public static apiV1InfrastructureTransportCarriersDestroy(
        id: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * {
         ...
         * @param area Filter by area ID (marine sites)
         ...
         * @param geography Filter by geography ID (marine areas or freshwater stations)
         * @param hall Filter by hall ID (freshwater facilities)
         * @returns any
         * @throws ApiError
         */
        ...
        /**
         * Aggregate feed purchase totals
         * Return aggregated totals for feed purchases applying the same filters as the standard list endpoint. Supports optional breakdowns grouped by supplier and/or feed.
         * @param endDate Filter purchases on or before this date (YYYY-MM-DD).
         * @param feed Filter by feed ID.
         * @param includeFeedBreakdown Set to true to include totals grouped by feed.
         * @param includeSupplierBreakdown Set to true to include totals grouped by supplier.
         * @param purchaseDate Filter by exact purchase date (YYYY-MM-DD).
         * @param search Search suppliers, batch numbers, or notes (matches list endpoint).
         * @param startDate Filter purchases on or after this date (YYYY-MM-DD).
         * @param supplier Filter by supplier name (exact match).
         * @returns any
         * @throws ApiError
         */
        public static feedPurchasesSummary(
            endDate?: string,
            feed?: number,
            ...
            /**
             * Total quantity purchased in kilograms.
             */
            total_quantity_kg?: number;
            /**
             * Total spend across all purchases in the result set.
             */
            total_spend?: number;
            /**
             * Average cost per kilogram for the result set.
             */
            ...
            return __request(OpenAPI, {
                method: 'GET',
                url: '/api/v1/inventory/feed-purchases/summary/',
                query: {
                    'end_date': endDate,
                    'feed': feed,
                    'include_feed_breakdown': includeFeedBreakdown,
                    'include_supplier_breakdown': includeSupplierBreakdown,
                    'purchase_date': purchaseDate,
                    'search': search,
                    'start_date': startDate,
                    'supplier': supplier,
         ...
         * @param geography Filter by geography ID across marine areas and freshwater stations
         ...
         * @param containerIn Filter by multiple container IDs (comma-separated).
         ...
         * @param freshwaterStation Filter by freshwater station ID.
         * @param freshwaterStationIn Filter by multiple freshwater station IDs (comma-separated).
         * @param geography Filter by geography ID across area and freshwater contexts.
         * @param geographyIn Filter by multiple geography IDs (comma-separated).
         * @param hall Filter by hall ID.
         * @param hallIn Filter by multiple hall IDs (comma-separated).
        ...
        /**
         * Get projection preview showing scenario-based rationale for activity due date.
         * @param id A unique integer value identifying this Planned Activity.
         * @returns any
         * @throws ApiError
         */
        public static apiV1PlanningPlannedActivitiesProjectionPreviewRetrieve(
            id: number,
        ): CancelablePromise<Record<string, any>> {
            return __request(OpenAPI, {
                method: 'GET',
                url: '/api/v1/planning/planned-activities/{id}/projection-preview/',
                path: {
                    'id': id,
                },
                errors: {
        ...
        /**
         * Get variance-from-actual data for a specific activity by joining with ActualDailyAssignmentState.
         * @param id A unique integer value identifying this Planned Activity.
         * @returns any
         * @throws ApiError
         */
        public static apiV1PlanningPlannedActivitiesVarianceFromActualRetrieve(
            id: number,
        ): CancelablePromise<Record<string, any>> {
            return __request(OpenAPI, {
                method: 'GET',
                url: '/api/v1/planning/planned-activities/{id}/variance-from-actual/',
                path: {
                    'id': id,
                },
                errors: {
         ...
         * @param scenario
         * @param search A search term.
         * @returns PaginatedProjectionRunListList
         * @throws ApiError
         */
        public static apiV1ScenarioProjectionRunsList(
            ordering?: string,
            page?: number,
            scenario?: number,
            search?: string,
        ): CancelablePromise<PaginatedProjectionRunListList> {
            return __request(OpenAPI, {
                method: 'GET',
                url: '/api/v1/scenario/projection-runs/',
                query: {
                    'ordering': ordering,
                    'page': page,
                    'scenario': scenario,
         ...
         * Creating runs is done via Scenario.run_projection action.
         * Deleting runs requires Manager+ role.
         * @param runId A unique integer value identifying this Projection Run.
         * @returns ProjectionRunDetail
         * @throws ApiError
         */
        public static apiV1ScenarioProjectionRunsRetrieve(
            runId: number,
        ): CancelablePromise<ProjectionRunDetail> {
            return __request(OpenAPI, {
                method: 'GET',
                url: '/api/v1/scenario/projection-runs/{run_id}/',
                path: {
                    'run_id': runId,
                },
                errors: {
         ...
         * @param runId A unique integer value identifying this Projection Run.
         * @returns ProjectionRunList
         * @throws ApiError
         */
        public static apiV1ScenarioProjectionRunsProjectionsRetrieve(
            runId: number,
        ): CancelablePromise<ProjectionRunList> {
            return __request(OpenAPI, {
                method: 'GET',
                url: '/api/v1/scenario/projection-runs/{run_id}/projections/',
                path: {
                    'run_id': runId,
                },
                errors: {
         ...
         * @param all If true, returns all scenarios. By default, only returns scenarios created by the current user.
         * @param createdBy
         * @param ordering Which field to use when ordering the results.
         * @param page A page number within the paginated result set.
         * @param search A search term.
         ...
         * {
             ...
             * @throws ApiError
             */
            public static apiV1ScenarioScenariosProjectionRunsRetrieve(
                scenarioId: number,
            ): CancelablePromise<Scenario> {
                return __request(OpenAPI, {
                    method: 'GET',
                    url: '/api/v1/scenario/scenarios/{scenario_id}/projection_runs/',
                    path: {
                        'scenario_id': scenarioId,
                    },
                    errors: {
                         ...
                         * {
                             ...
                             * "ranges": [
                                ...
                                public static listUsersUserProfileHistory(
                                    ...
                                    ordering?: string,
                                    page?: number,
                                    role?: 'ADMIN' | 'FIN' | 'MGR' | 'OPR' | 'QA' | 'SHIP_CREW' | 'VET' | 'VIEW',
                                    search?: string,
                                    subsidiary?: 'ALL' | 'BS' | 'FM' | 'FW' | 'LG',
                                    user?: number,
